<template>
    <div>
        <v-card class="mt-2">
          <v-toolbar flat color="#d6ec78" light class="d-flex justify-center">
            <v-toolbar-title>Add New Fertilizing Activity</v-toolbar-title>
          </v-toolbar>
          <v-card-text>
            <v-container>
              <v-form ref="addForm">
                ...
                >
                  ...
                  <v-col cols="6" sm="4">
                    <v-autocomplete
                      v-model="itemInEdit.fertilizer"
                      :items="fertilizersList"
